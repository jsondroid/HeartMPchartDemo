...
//                minOffset = Math.max(minOffset, x.mLabelRotatedWidth);//原始写法
                minOffset = Math.max(minOffset, x.mLabelRotatedHeight);
            }
        }
...
//        mViewPortHandler.restrainViewPort(offsetLeft, offsetTop, offsetRight, offsetBottom);//原始写法
        mViewPortHandler.restrainViewPort(offsetLeft, offsetTop+minOffset*2, offsetRight, offsetBottom/2);//修改
