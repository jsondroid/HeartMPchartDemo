...
//                    c.drawText(label,
//                            mViewPortHandler.contentRight() - xOffset,
//                            pts[1] + yOffset, mLimitLinePaint);//原来的

                    float xp=mViewPortHandler.getChartWidth()/13f*l.getX();
                    float width = Utils.calcTextWidth(mLimitLinePaint, l.getLabel());
                    c.drawText(label,xp+width, pts[1] + yOffset, mLimitLinePaint);//
